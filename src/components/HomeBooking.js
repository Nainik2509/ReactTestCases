...
const HomeBooking = (props) => {
    ...
    // Having access to check-in and check-out dates, how can we calculate the total price?
    ...
    }, [props, checkOutState, checkInState])
    ...
    return (
        <div>
            <h2 data-testid='title'>{props.home ? props.home.title : null}</h2>
